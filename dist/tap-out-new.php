...
if(isset($_POST['submit_tapout']))
{
    ...
    $row = mysqli_fetch_array($res);
              ...
              { 
                ...
                { //user active
                      $imgname = $row['id_no'];
                      $bordercolor = "#83B336";
                      $notif_msg_header = "Welcome ".$imgname."";
                      $notif_msg_details = "You .";
                }
                    else
                    {
                       $imgname = $row['id_no'];
  ...
  else
  {
                  ...
                  $imgname = "placeholder";
                  $notif_msg_header = "INVALID";
                  $notif_msg_details = "Thank you for visiting us";
                  $notif_msg_sender = "Thank you for visiting us";
                  $card1hide = "";
  }
...
<div class="myBar label-center" style="position: absolute; float: right; right: 10px; top: 10px; color: white;" data-value="0"></div>
        ...
        <h1 style="text-align: center;margin: 0; padding: 0; font-size: 2.5rem;letter-spacing: 1px;"> INSTITUTION NAME</h1>
        <h4 style="text-align: center;margin: 0; padding: 0; letter-spacing: 1px;"> some small text here</h4>
        </div>
...
<div class="row">
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-1"></div>
        <div class="col-5 slide-right" id="card1" style="align-items: center;">
          <div class="card" style="background: rgba(0, 0, 0, 0.4);">
            <div class="card-header" style="border-color: white; color: cyan;"><?php echo $notif_msg_header; ?></div>
            <div class="card-body">
              <div style="height: 50vh; color: white;"><?php echo $notif_msg_details; ?></div>
            </div>
          </div>
        </div>
